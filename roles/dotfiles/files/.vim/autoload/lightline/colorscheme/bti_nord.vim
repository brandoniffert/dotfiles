...
let s:p.normal.left = [ [ s:nord1, s:nord8, 'bold' ], [ s:nord5, s:nord0 ] ]
let s:p.normal.middle = [ [ s:nord5, s:nord0 ] ]
...
let s:p.visual.left = [ [ s:nord1, s:nord7, 'bold' ], [ s:nord5, s:nord0 ] ]
...
" Turn on bold
highlight! User1 cterm=bold ctermfg=7 ctermbg=16 gui=bold guifg=#E5E9F0 guibg=#2E3440

" Turn off bold
highlight! User2 ctermfg=7 ctermbg=16 guifg=#E5E9F0 guibg=#2E3440
