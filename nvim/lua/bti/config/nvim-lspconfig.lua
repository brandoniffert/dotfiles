...
local on_attach = function(client, bufnr)
  ...
  buf_map('n', '<LocalLeader>ld', '<cmd>lua vim.lsp.buf.definition()<CR>', opts)
  buf_map('n', '<LocalLeader>lD', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
  buf_map('n', '<LocalLeader>li', '<cmd>lua vim.lsp.buf.implementation()<CR>', opts)
  buf_map('n', '<LocalLeader>ln', '<cmd>lua vim.lsp.buf.rename()<CR>', opts)
  buf_map('n', '<LocalLeader>la', '<cmd>lua vim.lsp.buf.code_action()<CR>', opts)
  buf_map('n', '<LocalLeader>lr', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
  buf_map('n', '<LocalLeader>le', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
  buf_map('n', '<LocalLeader>lq', '<cmd>lua vim.diagnostic.setloclist()<CR>', opts)
  buf_map('n', '<LocalLeader>lf', '<cmd>lua vim.lsp.buf.formatting()<CR>', opts)
