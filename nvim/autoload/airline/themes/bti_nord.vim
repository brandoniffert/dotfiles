...
let g:airline#themes#bti_nord#palette = {}
...
let s:NMain = [s:nord1_gui, s:nord9_gui, s:nord1_term, s:nord8_term]
let s:NRight = [s:nord6_gui, s:nord2_gui, s:nord1_term, s:nord9_term]
let s:NMiddle = [s:nord6_gui, s:nord0_gui, s:nord4_term, s:nord3_term]
let g:airline#themes#bti_nord#palette.normal = airline#themes#generate_color_map(s:NMain, s:NRight, s:NMiddle)

let s:IMain = [s:nord1_gui, s:nord14_gui, s:nord1_term, s:nord6_term]
let s:IRight = [s:nord6_gui, s:nord2_gui, s:nord1_term, s:nord9_term]
let s:IMiddle = [s:nord4_gui, s:nord0_gui, s:nord4_term, s:nord3_term]
let g:airline#themes#bti_nord#palette.insert = airline#themes#generate_color_map(s:IMain, s:IRight, s:IMiddle)

let s:RMain = [s:nord1_gui, s:nord14_gui, s:nord1_term, s:nord14_term]
let s:RRight = [s:nord6_gui, s:nord2_gui, s:nord1_term, s:nord9_term]
let s:RMiddle = [s:nord4_gui, s:nord0_gui, s:nord4_term, s:nord3_term]
let g:airline#themes#bti_nord#palette.replace = airline#themes#generate_color_map(s:RMain, s:RRight, s:RMiddle)

let s:VMain = [s:nord1_gui, s:nord7_gui, s:nord1_term, s:nord7_term]
let s:VRight = [s:nord6_gui, s:nord2_gui, s:nord1_term, s:nord9_term]
